    ...
    const channel = member.client.channels.cache.get(guild.welcome.channel)
        ...
        try {
            ...
            if (channel) {
                ...
                const text = guild.welcome.welcome_message.replace("{user}", `<@${member.user.id}>`).replace("{guild}", member.guild.name).replace("{memberCount}", member.guild.memberCount)
...
export const pActive = async (member) => {
    ...
    if (channel) {
        ...
        const text = guild.welcome.welcome_message.replace("{user}", member.user.username).replace("{guild}", member.guild.name).replace("{memberCount}", member.guild.memberCount)
